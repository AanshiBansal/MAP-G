...
class Emotion2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showComponent: false,
    ...
    handleClick = (event)=>{
        ...
        this.props.emotionAns({a:event.target.id,b:"2",c:timeAnswer,emailId:this.props.userInfo.email});
        this.setState({
            redirectstate: true,
...
export default connect(mapStateToProps, {emotionAns})(Emotion2);