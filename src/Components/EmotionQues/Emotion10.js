...
class Emotion10 extends Component {
    ...
    handleClick = (event)=>{
        ...
        this.props.emotionAns({a:event.target.id,b:10,c:timeAnswer,emailId:this.props.userInfo.email});
        this.setState({
            redirectstate: true,
    ...
    render() {
        return (
            <div>
                ...
                <Card header ='10/14' style={{textAlign:'center'}}/>
                <Image src={require('./pic10.jpg')} centered />
                <br/>
                <p>
                    <span>
...
export default connect(mapStateToProps, {emotionAns})(Emotion10);