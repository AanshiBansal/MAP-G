...
class Emotion11 extends Component {
    ...
    handleClick = (event)=>{
        ...
        this.props.emotionAns({a:event.target.id,b:"11",c:timeAnswer,emailId:this.props.userInfo.email});
        this.setState({
            redirectstate: true,
    ...
    render() {
        return (
            <div>
                ...
                <Card header ='11/14' style={{textAlign:'center'}}/>
                <Image src={require('./pic11.jpg')} centered/>
                <br/>
                <p>
                    <span>
...
export default connect(mapStateToProps, {emotionAns})(Emotion11);