...
class Emotion13 extends Component {
    ...
    handleClick = (event)=>{
        ...
        this.props.emotionAns({a:event.target.id,b:"13",c:timeAnswer,emailId:this.props.userInfo.email});
        this.setState({
            redirectstate: true,
...
export default connect(mapStateToProps, {emotionAns})(Emotion13);