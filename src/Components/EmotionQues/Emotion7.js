...
class Emotion7 extends Component {
    ...
    handleClick = (event)=>{
        ...
        this.props.emotionAns({a:event.target.id,b:"7",c:timeAnswer,emailId:this.props.userInfo.email});
        this.setState({
            redirectstate: true,
    ...
    render() {
        return (
            <div>
                ...
                <Card header ='7/14' style={{textAlign:'center'}}/>
                <Image src={require('./pic7.jpg')} centered/>
                <br/>
                <p>
                    <span>
...
export default connect(mapStateToProps, {emotionAns})(Emotion7);